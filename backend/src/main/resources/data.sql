...
INSERT IGNORE INTO roles (id, role_name, created_at, updated_at, created_by, updated_by)
VALUES 
(1, 'USER', NOW(), NOW(), 'system', 'system'),
(2, 'CARDEALER', NOW(), NOW(), 'system', 'system'),
(3, 'ADMIN', NOW(), NOW(), 'system', 'system');

-- Seed addresses (idempotent examples for cities)
INSERT IGNORE INTO address (pickup_address, drop_address, created_at, updated_at, created_by, updated_by)
VALUES
